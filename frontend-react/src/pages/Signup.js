...
import { EyeIcon, EyeSlashIcon as EyeOffIcon, LockClosedIcon, EnvelopeIcon as MailIcon, UserIcon } from '@heroicons/react/24/outline';
      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-muted">
            Start your personality discovery journey
          </p>
        </div>
